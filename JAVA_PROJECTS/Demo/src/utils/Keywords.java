package utils;
	...
	public class Keywords {
		...
		/*
	public String click(String objectKey,String locatorvalue) {
		System.out.println("Executing click");
		try {
			// TODO Auto-generated method stub
			switch(locatorvalue){
			case "xpath" : driver.findElement(By.xpath(OR.getProperty(objectKey))).click();
			case "name"  : driver.findElement(By.name(OR.getProperty(objectKey))).click();
			...
			return "Fail - not able to click - "+objectKey;
